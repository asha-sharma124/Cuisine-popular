...
#             cart_items = cart.cartitem_set.all()  # Fixing relationship to `cartitem_set`
...
#                 "cart_items": [
#                     {
#                         "name": item.item.name,  # Adjust according to your CartItem model
#                         "price": item.item.price,
#                         "quantity": item.quantity,
...
#         return Response(
#             {"cart_items": serialized_items, "total_price": total_price},
#             status=status.HTTP_200_OK
#         )